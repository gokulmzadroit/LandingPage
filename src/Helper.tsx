...
export function encrypt(data: any, token: any) {
    ...
    const ENCRYPT_API = '2a12CT173hlr7UwXJkfxiWN2OZhOTAi8xgwU6L9e0OktcddJZwcIfBn2'; // Replace with your actual secret
...
function decrypt(encryptedData: any, token: any) {
    if (!Array.isArray(encryptedData) || encryptedData.length !== 2) {
        throw new Error('Invalid encrypted data format');
    }

    // Use the same secret as your Go ENCRYPT_API env var
    const ENCRYPT_API = '2a12CT173hlr7UwXJkfxiWN2OZhOTAi8xgwU6L9e0OktcddJZwcIfBn2';
    const secret = ENCRYPT_API + token;
    const key = CryptoJS.SHA256(secret);
